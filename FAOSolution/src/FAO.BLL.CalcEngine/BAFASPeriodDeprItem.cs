...
{
    public class BAFASPeriodDeprItem : IBAPeriodDeprItem
    {
        ...
        public double EndDateYTDExpense
        {
            get
            {
                ...
                dTmp = (double)((m_curBeginYearAccum) + (m_curBeginYTDExpense)
                     + (m_curDeprAmount) - (m_curEndDateBeginYearAccum));
                return dTmp;
            }
        }
