...
namespace FAO.BLL.CalcEngine
{
    class MonthlyYear
    {
        ...
        public DateTime GetMidQuarterDate(DateTime dtDate)
        {
            ...
            dtMidQtr = (dtSDate.AddDays(iDayOffSet + iQtrNumDays / 2));
        ...
        public short GetMidQuarterNumber(DateTime dtDate)
        {
            ...
            if (IsMonthlyQuarter())
            {
                ...
                dtMidQuarterDate = new DateTime((m_dtDeemedFYStart.Year), (m_dtDeemedFYStart.Month),
                                    iQtrDay);
                dtMidQuarterDate = dtMidQuarterDate.AddMonths(iQtrMonth - 1);
