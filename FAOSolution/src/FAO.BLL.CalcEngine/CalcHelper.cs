...
namespace FAO.BLL.CalcEngine
{
    ...
    public class CalcHelper
    {
        ...
        public void FlipSign(ref List<IBAPeriodDeprItem> pInList)
        {
            foreach (IBAPeriodDeprItem pdi in pInList)
            {
                pdi.BeginYearAccum = - pdi.BeginYearAccum;
                pdi.DeprAmount = - pdi.DeprAmount;
                pdi.BeginYTDExpense = - pdi.BeginYTDExpense;
                pdi.AdjustAmount = - pdi.AdjustAmount;
                pdi.Section179Change = - pdi.Section179Change;
                pdi.EndDateBeginYearAccum = - pdi.EndDateBeginYearAccum;
            }
        }
    }
}
