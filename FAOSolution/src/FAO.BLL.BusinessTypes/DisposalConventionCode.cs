...
{
    public class DisposalConventionCode : DisposalConvention
    {
        public DisposalConventionCode(DisposalConventionCode obj)
        { copyFrom(obj); }

        public DisposalConventionCode(DisposalConvention obj) :
            base(obj)
        { }

        public DisposalConventionCode(char shortName)
        {
            defaults();
        ...
        public static bool operator ==(DisposalConventionCode left, DisposalConventionCode right)
        {
        ...
        {
            return this == (DisposalConventionCode)o;
        }
        ...
        public void copyFrom(DisposalConventionCode obj)
        { base.copyFrom(obj); }
