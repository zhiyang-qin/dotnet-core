...
namespace FAO.BLL.Calendar.Interfaces
{
    public interface IBACalendar
    {
        ...
        IEnumerable<IBAFiscalYear> GetFiscalYearList(DateTime dtStartDate, DateTime dtEndDate);
        IEnumerable<IBACalcPeriod> GetPeriodList(DateTime dtStartDate, DateTime dtEndDate);
