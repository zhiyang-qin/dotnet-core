...
{
    public class BAFASCalendar : IBACalendar, IBACalendarManager, IBAPersistXML
    {
        ...
        public string AttributeString 
        {
            get
            {
                return m_persist.AttributeString;
            }
            set
            {
                m_persist.AttributeString = value;
            }
        }
        ...
        public int AttributeCount
        {
            get
            {
                return m_persist.AttributeCount;
            }
        }

        public bool AttributeName(int index, out string pVal)
        {
            return m_persist.AttributeName(index, out pVal);
        }

        public bool get_Attribute(string name, out string pVal)
        {
            return m_persist.get_Attribute(name, out pVal);
        }

        public bool set_Attribute(string name, string newVal)
        {
            return m_persist.set_Attribute(name, newVal);
        }

        public bool AttributeID(string name, out int pVal)
        {
            return m_persist.AttributeID(name, out pVal);
        }

        public bool RemoveAttribute(string name)
        {
            return m_persist.RemoveAttribute(name);
        }

        public bool RemoveAllAttributes()
        {
            return m_persist.RemoveAllAttributes();
        }
    }
}
